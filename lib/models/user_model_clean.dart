/// Clean user model for RivalX without Firebase dependencies.
/// 
...
/// data structure for user information throughout the app without requiring
/// Firebase or Firestore dependencies.
...
class UserModel extends Equatable {
  ...
  /// 
  /// @param data Map containing user data fields
  ...
  factory UserModel.fromJson(Map<String, dynamic> data) {
    return UserModel(
      ...
      dateJoined: DateTime.parse(data['dateJoined'] ?? DateTime.now().toIso8601String()),
      ...
      rivalSelectionDate: data['rivalSelectionDate'] != null
          ? DateTime.parse(data['rivalSelectionDate'])
          : null,
    );
  }

  /// Converts UserModel to JSON-compatible map
  /// 
  /// @return Map ready for storage or transmission
  Map<String, dynamic> toJson() {
    return {
      ...
      'rivalSelectionDate': rivalSelectionDate?.toIso8601String(),
    };
  }
  ...
  /// Gets display text for rank level
  /// 
  /// @return Formatted rank display string
  String get rankDisplayText {
    switch (currentRank) {
      case RankLevel.E:
        return 'Rookie (E)';
      case RankLevel.D:
  ...
  /// 
  /// @return Formatted fitness level display string
  String get fitnessLevelDisplayText {
    switch (fitnessLevel) {
  ...
  /// Whether user has an active rival
  bool get hasActiveRival => currentRivalId != null;

  /// Whether user has completed profile setup
  bool get hasCompleteProfile => height != null && weight != null && fitnessLevel != null;
